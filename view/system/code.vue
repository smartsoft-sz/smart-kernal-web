...
<template>
  <div class="smart-crud-container">
    ...
    <Modal
        ...
        :title="modalTitle"
        :styles="{top: '20px'}">
      <Form ref='codeForm' :model='codeForm' :rules='codeFormRule' :label-width='120'>
        <FormItem label='Code:' prop='code'>
          <Input v-model='codeForm.code' :maxlength=30 placeholder='请输入code' style="width: 200px"/>
        </FormItem>
        <FormItem label='名称:' prop='name'>
          <Input v-model='codeForm.name' :maxlength=50 placeholder='请输入名称' style="width: 200px"/>
        </FormItem>
        <FormItem label='序号:' prop='seqNum'>
          <InputNumber v-model='codeForm.seqNum' :max='99999999999' :min='0'/>
        </FormItem>
        <FormItem label='描述:' prop='description'>
          <Input v-model='codeForm.description' type='textarea' :maxlength=500 style="width: 200px"
                 :autosize='{minRows: 2,maxRows: 5}'
                 placeholder='请输入描述'/>
        </FormItem>
        <FormItem label='CodeGroup:' prop='codeGroupCode'>
          <Select v-model='codeForm.codeGroupCode' filterable style="width: 200px">
